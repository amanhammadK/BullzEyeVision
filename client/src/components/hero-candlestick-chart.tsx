...
function CandlestickChart3D({ scrollProgress }: { scrollProgress: number }) {
...
// Main Hero Candlestick Chart Component
export default function HeroCandlestickChart() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const maxScroll = windowHeight; // Hero section height
  ...
  return (
    ...
    >
      ...
      >
        ...
        <CandlestickChart3D scrollProgress={scrollProgress} />
