...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Soft Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-white/70 dark:bg-black/20 border-b border-black/10 dark:border-white/10">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <div className="text-2xl font-semibold tracking-wide">
                ...
                <span className="text-[#398848]">EYE</span>
              </div>
            </div>
            ...
            <div className="md:hidden flex items-center space-x-4">
              ...
              <Button
                ...
                className="text-white hover:text-[#398848] p-2"
              >
      ...
      {showScrollTop && (
        <Button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-50 w-12 h-12 bg-[#d60c16] hover:bg-[#b50a13] text-white rounded-full transition-all duration-200"
          size="sm"
